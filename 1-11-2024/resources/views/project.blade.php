...
<meta name="link" content="index.html" />
...
<link rel="shortcut icon" href="images/logo.html" title="LIVE Builders"  />
<link href="#" rel="search" title="Search LIVE Builders" type="application/opensearchdescription+xml"/>
<meta http-equiv="content-type" content="text/html; charset=utf-8"/>
<link rel="icon" type="image/png" href="images/logo.html">
<meta name="viewport" content="width=device-width, initial-scale=1"/>
    <!-- FAVICONS ICON -->
    <link rel="icon" href="images/logo.html" type="image/x-icon" />
                ...
                <div class="main-bar bg-primary" style="height: 90;">
                    <div class="container">
                        ...
                        <div class="logo-header mostion header-skew">
                            <a href="home.html">
                                <img src="assets/images/about.png" width="200" height="67" alt="" />
                            </a>
                        </div>
                        <!-- NAV TOGGLE BUTTON -->
                            ...
                            <ul class=" nav navbar-nav">
                                ...
                                <li>
                                    <a href="javascript:;">Projects<i class="fa fa-chevron-down"></i></a>
                                            <ul class="sub-menu">
                                                <li><a href="projects/3.html">Completed Project</a></li>
                                                <li><a href="projects/2.html">Progress Project</a></li>
                                            </ul>
                                        </li>
                                <li>
         ...
         <div class="col-md-4 col-sm-6">
            <div class="widget widget_about">
               ...
               <div class="logo-footer clearfix p-b15">
                  <a href="contact-us.html"><img src="assets/images/logo.png" width="230" height="67" alt=""/></a>
               </div>
         ...
         <div class="col-md-4 col-sm-6">
            <div class="widget widget_services">
               ...
               <ul>
                  ...
                  <li><a href="completed.html">Completed Project</a></li>
                  <li><a href="upcoming.html">Upcoming Project</a></li>
                  <li><a href="progress.html">Progress Project</a></li>
