 <header class="site-header header-style-1 ">
                    ...
                    <div class="container">
                        ...
                        <div class="logo-header mostion header-skew">
                            <a href="<?php echo e(url('home')); ?>">
                                <img src="<?php echo e(URL::to('/')); ?>/assets/images/about.png" width="200" height="67" alt="" />
                            </a>
                        </div>
                        <!-- NAV TOGGLE BUTTON -->
        ...
        </header> <?php /**PATH C:\xampp\htdocs\livebuilders.in\resources\views/layouts/header.blade.php ENDPATH**/ ?>