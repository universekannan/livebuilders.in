...
<head>
  ...
  <title>LIVE Builders Upcoming</title>
            ...
            <div class="wt-bnr-inr overlay-wraper" style="background-image:url(images/banner/all.jpg);">
                ...
                <div class="container">
                    <div class="wt-bnr-inr-entry">
                     <center>   <h1 class="text-white">Upcoming Projects</h1></center> 
                    </div>
                </div>
            </div>
            ...
            <div class="section-full bg-white  p-t80 p-b70">
                <div class="container">
                    ...
                    <div class="section-content">
                        <div class="row">
                             <?php
                        $sql = "select * from project where category_id='3'";
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            ...
                            <div class="col-md-4 col-sm-4 m-b30">
                                <div class="wt-box">
                                    <div class="wt-media">
                                        <a href="project.php?id=<?php echo $row['id']; ?>"><img src="admin/photo/project/<?php echo $row['photo']; ?>" alt=""></a>
                                    </div>
                                    <div class="wt-info">
                                        <h4 class="wt-title m-t20"><a href="project.php"><?php echo $row['project_name']; ?></a></h4>
                                        <p><?php echo $row['project_address']; ?></p>
                                        <a href="project.php?id=<?php echo $row['id']; ?>" class="site-button skew-icon-btn ">More<i class="fa fa-angle-double-right"></i></a>
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
...
<!-- LOADING AREA START ===== -->
   <?php include"upcoming-loading.php"?>
